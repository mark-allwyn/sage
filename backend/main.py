...
# parse_ground_truth_csv is now imported from services.ground_truth_parser
...
async def upload_ground_truth_csv(
    ...
    try:
        ...
        parsed = parse_ground_truth_csv(csv_text, survey)
        parse_result = parsed.to_dict()  # Convert dataclass to dict for compatibility
